...
private:
    ...
    long int account_no;
public:
    InsertionSort(string nm, string gd, int hsc, float income, long int aadhar, long int acc, int elements[], int size) {
        name = nm;
        gender = gd;
        hsc_mark = hsc;
...
void InsertionSort::displayDetails() {
    cout << "Name: " << name << endl;
...
int main() {
    ...
    InsertionSort members[] = {
        InsertionSort("Alice", "Female", 95, 50000.0, 123456789012, 9876543210, elements1, 5),
        InsertionSort("Bob", "Male", 85, 60000.0, 234567890123, 8765432109, elements2, 5),
        InsertionSort("Charlie", "Male", 92, 45000.0, 345678901234, 7654321098, elements3, 5),
        InsertionSort("Diana", "Female", 88, 55000.0, 456789012345, 6543210987, elements4, 5),
        InsertionSort("Eve", "Female", 90, 62000.0, 567890123456, 5432109876, elements5, 5)
    };
...
Sorted array (Insertion Sort): 2 3 5 6 8 
...
Sorted array (Insertion Sort): 1 4 5 7 9 
...
Sorted array (Insertion Sort): 2 4 6 7 8 
...
Sorted array (Insertion Sort): 1 2 3 5 6 
...
Sorted array (Insertion Sort): 1 2 3 6 8 
*/